...
module.exports.add_cook_info = function (req, res, next) {
    ...
    db.cook_infos.save(
        ...
        , function (err, cook_details) {
            ...
            var message = "Dear " + req.body.basic_detail.cook_name + " Thanks For Registering with EatoEato as a Cook, You Will Start Receiving Orders Shortly.!"
            ...
            , function (err, data, lastErrorObject) {
                ...
                db.track_order_infos.update(
                    ...
                    , function (err, user, lastErrorObject) {
                        ...
                        db.order_infos.find({ 'order_id': order_id }, { user_id: 1 }, function (err, usdata) {
                ...
                , function (err, data, lastErrorObject) {
                    ...
                    db.track_order_infos.update(
                        ...
                        , function (err, user, lastErrorObject) {
                            ...
                            db.order_infos.find({ order_id: order_id }, { delivery_id: 1 }, function (err, dvcode) {
                                ...
                                db.sms_template_infos.find({ 'name': 'Order Ready To Delivery/ User' }, function (err, smstemplate_data) {
                                    ...
                                    request("http://smsgate.idigitie.com/http-api.php?username=eatoeato&password=idid@1234&senderid=EATOET&route=1&number=" + parseInt(9643788187) + "&message=" + smstemplate, function (error, response, body) {
                                        if (!error && response.statusCode == 200) {
                                            console.log('SMS SEND') // Print the google web page.
                                        }
                                    });
