        ...
        db.user_infos.find({
            ...
            if (user_details_phone != "") {
                ...
                db.user_infos.save({
                    ...
                    var message = "Dear " + req.body.user_name + " Thanks For Registering with EatoEato, It would be Pleasure to serve you."
                    ...
                    for (var t = 0; t < cat_list.length; t++) {
                        ...
                        for (var n = 0; n < u.food_details.length; n++) {
                            ...
                            for (var s = 0; s < u.food_details[n].occassion_list.length; s++) {
                                ...
                                if (u.food_details[n].occassion_list[s].group_attr == cat_list[t] && u.food_details[n].occassion_list[s].status == "true" && u.food_details[n].food_isApproved == "Approved") {
...
router
    .post('/get-payu-data', function (req, res, next) {
        ...
        console.log(req.body);
        res.redirect('http://eatoeato.com:3000/user/payu-test' + req.body);
    })
...
router
    .post('/payu-process', function (req, res, next) {
        ...
        if (req.body.status == 'failure') {
            ...
            res.redirect('http://eatoeato.com:3000/#/payment/failure');
        ...
        if (req.body.status == 'success') {
            ...
            res.redirect('http://eatoeato.com:3000/#/payment/success');
