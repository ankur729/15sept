...
app.controller('user_register', ['$scope', '$http', '$location', '$cookieStore', '$timeout', '$routeParams', '$base64', '$rootScope', 'cfpLoadingBar', 'Notification', '$route', '$localStorage', '$window', 'blockUI', '$crypthmac', function ($scope, $http, $location, $cookieStore, $timeout, $routeParams, $base64, $rootScope, cfpLoadingBar, Notification, $route, $localStorage, $window, blockUI, $crypthmac) {
                ...
                navigator.geolocation.getCurrentPosition(function (p) {
                    ...
                    for (var i = 0; i < $localStorage.lat_long_coll.length; i++) {
                        ...
                        markerB = new google.maps.Marker({
                            ...
                            map: map,
                            icon: 'https://eatoeato.com:3000/uploads/q.png'
                        });
    ...
    $scope.fetch_avail_by_time_of_food = function () {
        ...
        if (last2 == "pm") {
            ...
            if (first2 == 12) {
                ...
                if (first2 > 23) {
                    ...
                    swal("Sorry.. :(", "You Can Select Time Only Between 9:00 AM To 11 PM", "error");
                    $('#order_time').val('');
                }
                if (first2 == 23) {
        ...
        if (last2 == "am") {
            ...
            if (first2 > 8) {
                ...
                swal("Sorry.. :(", "You Can Select Time Only Between 9:00 AM To 11:00 PM", "error");
                $('#order_time').val('');
            }
    ...
    $scope.payment_gateway_wallet_online = function () {
        ...
        $scope.pay_model.surl = "http://eatoeato:3000/user/payu-process-wallet-online";
        $scope.pay_model.furl = "http://eatoeato:3000/user/payu-process-wallet-online";
    ...
    $scope.payment_gateway_test = function () {
        ...
        $scope.pay_model.surl = "http://eatoeato.com:3000/user/payu-process";
        $scope.pay_model.furl = "http://eatoeato.com:3000/user/payu-process";
    ...
    $scope.payment_gateway_wallet = function () {
        ...
        $scope.pay_model.surl = "http://eatoeato:3000/user/payu-wallet-process";
        $scope.pay_model.furl = "http://eatoeato:3000/user/payu-wallet-process";
...
app.controller('delivery_boy_controller', ['$scope', '$http', '$route', '$rootScope', '$timeout', '$base64', 'cfpLoadingBar', 'Notification', '$cookieStore', '$location', '$localStorage', 'blockUI', function ($scope, $http, $route, $rootScope, $timeout, $base64, cfpLoadingBar, Notification, $cookieStore, $location, $localStorage, blockUI) {
                ...
                if ($('#mobileno').val().length > 9 && $('#mobileno').val().length < 11) {
                    ...
                    $http({
                        ...
                        if (response.data.status == 'failiure') {
                            ...
                            $location.path('/deliveryboy/pickup');
...
app.controller('admin_controller', ['$scope', '$http', 'FileSaver', 'Blob', '$rootScope', '$timeout', '$base64', 'cfpLoadingBar', 'Notification', '$cookieStore', '$location', '$localStorage', 'blockUI', function ($scope, $http, FileSaver, Blob, $rootScope, $timeout, $base64, cfpLoadingBar, Notification, $cookieStore, $location, $localStorage, blockUI) {
    $rootScope.stylesheets = "";
    $rootScope.stylesheets = [
        { href: '../../pages/admin/css/reset.css', type: 'text/css' },
        { href: '../../../pages/admin/css/style.css', type: 'text/css' },
