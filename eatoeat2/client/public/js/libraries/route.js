...
app.config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
    $routeProvider
        ...
        .when('/payment', {
          ...
          .when('/payu', {
            title: 'Payment',
            templateUrl: 'pages/user/payu.html',
            controller: 'MainCtrl'
        })

          .when('/wallet_payu', {
            title: 'Payment',
            templateUrl: 'pages/user/wallet-payu.html',
            controller: 'MainCtrl'
        })
           .when('/payu-wallet-online', {
            title: 'Payment',
            templateUrl: 'pages/user/payu_wallet_online.html',
            controller: 'MainCtrl'
        })
        ...
        .when('/admin', {
           ...
           .when('/admin/password-change', {
            title: 'admin',
            templateUrl: 'pages/admin/password-change.html',
            controller: 'MainCtrl'
        })
        ...
        .when('/admin/view-cook-income-detail', {
            title: 'add user',
            templateUrl: 'pages/admin/view-marketplace-income-orders.html',
            controller: 'MainCtrl'
        })
        ...
        .when('/admin/view-seller-review', {
           ...
           .when('/admin/edit-review', {
            title: 'Review',
            templateUrl: 'pages/admin/edit-review.html',
            controller: 'MainCtrl'
        })
        ...
        .when('/admin/refund-orders', {
            title: 'add user',
            templateUrl: 'pages/admin/order-refund.html',
            controller: 'MainCtrl'
        })
        ...
        .when('/verify-user-params/:user_id/:email', {
            title: 'add user',
            templateUrl: 'pages/verify-email-params.html',
            controller: 'MainCtrl'
        })

        .when('/verify-cook-params/:cook_id/:email', {
            title: 'add user',
            templateUrl: 'pages/verify-cook-email-params.html',
            controller: 'MainCtrl'
        })
        ////////// Management Center
        ...
        // DELIVERY BOY ROUTES
          ...
          .when('/deliveryboy/login', {
            title: 'Delivery-Boy-Login',
            templateUrl: 'pages/admin/delboylogin.html',
            controller: 'MainCtrl'
        })
         .when('/deliveryboy/pickup', {
            title: 'Pickup-Details',
            templateUrl: 'pages/admin/delboypickup.html',
            controller: 'MainCtrl'
        })
         .when('/deliveryboy/pickupdetails', {
            title: 'Pickup-Details',
            templateUrl: 'pages/admin/delboypickupdetails.html',
            controller: 'MainCtrl'
        })
          .when('/deliveryboy/drop', {
            title: 'Pickup-Details',
            templateUrl: 'pages/admin/delboydrop.html',
            controller: 'MainCtrl'
        })
         .when('/deliveryboy/dropdetails', {
            title: 'Pickup-Details',
            templateUrl: 'pages/admin/delboydropdetails.html',
            controller: 'MainCtrl'
        })
         .when('/deliveryboy/profiledetails', {
            title: 'Pickup-Details',
            templateUrl: 'pages/admin/delboyprofiledetails.html',
            controller: 'MainCtrl'
        })
